...
내용이 같다
/* why?
배운바에 의하면 equals는 객체 생성하면 객체 생성한 주소값이 달라서 
내용비교하는가 false로 와야하는데 ture가 와서 '내용이 같다'가 출력됨
그 이유는 String이 자기 목적에 맞게 부모에 있는 equals함수를 오버라이딩함
따라서 String은 주소비교가 아닌 내용 비교를 하게 만들었음! */
```
