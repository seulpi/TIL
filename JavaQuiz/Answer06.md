...
void 함수명 (parameter) //Parameter = 인자, 매개변수 {
	함수 호출 시 실행 될 내용;
}

//returnTupe이 void가 아닌 경우
int 함수명 (parameter) //Parameter = 인자, 매개변수 {
	함수 호출 시 실행 될 내용;
...
2. 함수 실행 시 메모리 방을 만들고, 함수의 실행이 끝나면 만들었던 방은 사라진다.
